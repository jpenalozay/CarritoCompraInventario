#!/usr/bin/env python3
"""
Script para generar datos de inventario para RL basándose en el Excel de retail existente - VERSION CORREGIDA
"""
import pandas as pd
import numpy as np
import random
...
class InventoryDataGenerator:
    def __init__(self):
        self.excel_path = '/tmp/online_retail.xlsx'
    ...
    def calculate_abc_classification(self, revenue_data):
        ...
        choices = ['A', 'B', 'C']
        sorted_data['abc_classification'] = np.select(conditions, choices)
        
        return dict(zip(sorted_data['StockCode'], sorted_data['abc_classification']))
    ...
    def generate_inventory_data(self, product_summary):
        ...
        # Limitar a los primeros 100 productos para prueba
        ...
        for _, product in top_products.iterrows():
            ...
            if abc_class == 'A':
                days_of_supply_target = random.uniform(30, 45)
            elif abc_class == 'B':
            ...
            # Calcular costos
            base_cost = product['avg_unit_price'] * random.uniform(0.4, 0.7)
            ...
            inventory_record = {
                ...
                'storage_cost_per_unit': round(base_cost * 0.02, 4),
            ...
            demand_record = {
                ...
                'demand_trend': round(random.uniform(-0.1, 0.1), 3),
    ...
    def insert_suppliers(self):
        ...
        for supplier in self.suppliers:
            bulk_discounts = {100: 0.02, 500: 0.05, 1000: 0.08}
            contact_info = {
